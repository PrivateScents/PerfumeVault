...
interface UsageLogDao {
    ...
    fun getLogsForPerfume(perfumeId: String): Flow<List<UsageLog>>
    ...
    fun getUsageCount(perfumeId: String): Flow<Int>
    ...
    suspend fun deleteAllForPerfume(perfumeId: String): Int
